...
`<plugin-root>/scripts/check_events.py`, the checker, reads a project's
...
`<plugin-root>/skills/spec/references/spec-format.md` under
...
`<plugin-root>/skills/spec/references/spec-format.md` (its events-table
