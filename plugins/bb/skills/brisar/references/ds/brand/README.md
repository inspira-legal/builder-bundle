...
1. **Brand primitives** — Inspira-specific names (cornflower-blue, rich-black, cool-gray). What the color _is_.
2. **Semantic aliases** — Abstract roles (bg-primary, text-inverse, interactive-primary). What the color _does_.
