...
- `.bb/<slug>/design.md`: `## Surfaces` for the visual direction and the chosen direction above it
- The artifact, via the reader for `medium.chosen`
- `.bb/<slug>/design.md`: the decisions recorded through the journey, and the `deviations[]` in the surfaces list
...
- Items to guarantee at merge: <the `blockers` in the frontmatter>
- Reference doc: `.bb/<slug>/design.md`, section `## Accessibility`
