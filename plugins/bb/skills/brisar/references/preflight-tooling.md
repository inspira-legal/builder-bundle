...
| The profile's `design_tools` names a tool whose MCP is absent                 | Said once, in the medium question's intro line; `phase-medium.md` (Step 1) owns the wording and what follows from it.                                                                          |
