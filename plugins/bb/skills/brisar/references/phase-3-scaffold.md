  ...
  <body>
    <main class="landing">
      ...
      <footer class="meta">
        ...
        <p class="hint">The written direction for each screen: <code>../design.md</code>.</p>
      </footer>
    </main>
  </body>
</html>
...
This prototype is for validating the idea. **It is not the final product.** The next step is
`/bb:spec`, which reads the journey in `../design.md` and writes the contract the technical team
builds from.
