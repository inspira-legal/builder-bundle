...
- `${CLAUDE_PLUGIN_ROOT}/scripts/gather_context.py`: the same branch context plus the commit log and the full diff, for a scope paragraph the probe's diff stat cannot carry.
