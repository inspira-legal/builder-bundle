...
names, unless that header has no `payload` column, which is the fourth C009 case above. In the events table the payload fields are the backticked tokens of the
